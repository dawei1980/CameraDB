            ...
            synchronized (mLock) {
                switch (MATCHER.match(uri)) {
                    case REMOVE_INFO_CODE:
                        Cursor cursor = mDatabase.query(RemoveInfoTable.REMOVE_TABLE_NAME,projection,selection,selectionArgs,null,null,sortOrder);;
                        return cursor;
                    default:
        ...
        try {
            ...
            switch (MATCHER.match(uri)) {
                case REMOVE_INFO_CODE:
                    ...
                    long rowid = mDatabase.insert(RemoveInfoTable.REMOVE_TABLE_NAME, null, values);
