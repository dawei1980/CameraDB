...
public class InstructionUpgrade {
    ...
    public static List<CommandInfo> getLowVersionInstructionData(SQLiteDatabase database){
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                info.setDeleteFlag(Boolean.valueOf(cursor.getString(cursor.getColumnIndexOrThrow(InstructionInfoTable.DELETE_FLAG))));
                ...
                info.setAlternateFlag(Boolean.valueOf(cursor.getString(cursor.getColumnIndexOrThrow(InstructionInfoTable.ALTERNATE_FLAG))));
                ...
                info.setEdge(Boolean.valueOf(cursor.getString(cursor.getColumnIndex(InstructionInfoTable.IS_EDGE))));
                info.setBaseUrl(cursor.getString(cursor.getColumnIndex(InstructionInfoTable.BASE_URL)));
                info.setUpdateDebugResultFlag(Boolean.valueOf(cursor.getString(cursor.getColumnIndex(InstructionInfoTable.UPDATE_DEBUG_RESULT_FLAG))));
    ...
    public static void insertTempAIData(CommandInfo commandInfo, SQLiteDatabase database){
        try {
            ...
            values.put(InstructionInfoTable.UPDATE_DEBUG_RESULT_FLAG,commandInfo.isUpdateDebugResultFlag());
